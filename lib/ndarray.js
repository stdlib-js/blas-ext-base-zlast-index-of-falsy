...
var zindexOfFalsy = require( '@stdlib/blas-ext-base-zindex-of-falsy' ).ndarray;
...
*
* var idx = zlastIndexOfFalsy( x.length, x, 1, 0 );
* // returns 4
*/
function zlastIndexOfFalsy( N, x, strideX, offsetX ) {
	var idx;
	...
	idx = zindexOfFalsy( N, x, strideX, offsetX );
	if ( idx < 0 ) {
		return idx;
	}
...
module.exports = zlastIndexOfFalsy;
